...
./pywrf.py wrf -t make_namelist -s 2012102703 -r 45 -i 10800 -o run_OSSE --inputout_interval 180
./pywrf.py wrf -t make_real_srun -o run_OSSE
./pywrf.py wrf -t real -o run_OSSE
...
# wrf 2012102703 -> 2012102818
./pywrf.py wrf -t make_namelist -s 2012102703 -r 45 -i 10800 -o run_OSSE \

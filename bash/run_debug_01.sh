...
#./pywrf.py wps -t make_namelist -s 2012102600 -e 2012102818 -i 10800 -o run_OSSE
...
#./pywrf.py wrf -t make_namelist -s 2012102606 -r 60 -i 10800 -o run_OSSE --inputout_interval 180
#./pywrf.py wrf -t make_real_srun -o run_OSSE
#./pywrf.py wrf -t real -o run_OSSE
#./pywrf.py wrf -t make_namelist -s 2012102600 -r 6 -i 21600 -o run_OSSE
#./pywrf.py wrf -t make_real_srun -o run_OSSE
#./pywrf.py wrf -t real -o run_OSSE
# wrf 2012102600 -> 2012102606
#./pywrf.py wrf -t make_namelist -s 2012102600 -r 6 -i 10800 -o run_OSSE \
...
#./pywrf.py wrf -t make_namelist -s 2012102606 -r 60 -i 10800 -o run_OSSE \
               #--history_interval 180 --inputout_interval 180 --inputout_begin_h 3
#./pywrf.py wrf -t make_wrf_srun -o run_OSSE
#./pywrf.py wrf -t wrf -o run_OSSE

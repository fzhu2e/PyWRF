...
./pywrf.py wrf -t make_real_srun -o run_OSSE
./pywrf.py wrf -t real -o run_OSSE
./pywrf.py wrf -t make_namelist -s 2012102706 -r 36 -i 10800 -o run_OSSE --inputout_interval 180
./pywrf.py wrf -t make_real_srun -o run_OSSE
./pywrf.py wrf -t real -o run_OSSE
...
# wrf 2012102706 -> 2012102818
./pywrf.py wrf -t make_namelist -s 2012102706 -r 36 -i 10800 -o run_OSSE \
               --history_interval 180 --inputout_interval 180 --inputout_begin_h 42
./pywrf.py wrf -t make_wrf_srun -o run_OSSE
./pywrf.py wrf -t wrf -o run_OSSE

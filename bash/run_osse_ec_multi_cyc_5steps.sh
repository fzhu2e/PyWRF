...
## 2700, 2703, 2706, 2709, 2712 E

## 2706, 2709, 2712, 2715, 2718 S
cp -r $RESULTS/OSSE_ec_multi_cyc_bak $RESULTS/OSSE
sleep $SLEEP_TIME
# real
./pywrf.py wrf -t make_namelist -s 2012102706 -r 3 -i 10800 -o run_OSSE
...
## 2706, 2709, 2712, 2715, 2718 E

## 2712, 2715, 2718, 2721, 2800 S
cp -r $RESULTS/OSSE_ec_multi_cyc_bak $RESULTS/OSSE
sleep $SLEEP_TIME
# real
./pywrf.py wrf -t make_namelist -s 2012102712 -r 3 -i 10800 -o run_OSSE

...
./pywrf.py wrf -t make_namelist -s 2012102700 -r 42 -i 10800 -o run_OSSE --inputout_interval 180
...
# wrf 2012102700 -> 2012102818
./pywrf.py wrf -t make_namelist -s 2012102700 -r 42 -i 10800 -o run_OSSE \
               --history_interval 180 --inputout_interval 180 --inputout_begin_h 48
./pywrf.py wrf -t make_wrf_srun -o run_OSSE
./pywrf.py wrf -t wrf -o run_OSSE
